...
export const createProductController = async (req, res) => {
    try {
        ...
        switch (true) {
            ...
            case !description:
                return res.status(500).send({error: "Description of product is required"})
            case !price:
                return res.status(500).send({error: "Price of product is required"})
            case !category:
                return res.status(500).send({error: "Category of product is required"})
            case !quantity:
                return res.status(500).send({error: "Quantity of product is required"})
            case image && image.size > 1000000:
                return res.status(500).send({error: "Image of product is required & should be less than 1mb"})
